...
const Section1instructos = () => {
    ...
    useEffect(()=>{
        axios.get(`http://localhost:5000/api/user/instructors` ,{withCredentials:true}).then((res)=>setdiplomas(res.data.data)).catch((err)=>console.log(err))
    },[])
    let deleted =(id)=>{
      setErrors([])
      console.log(id)
...
export default Section1instructos
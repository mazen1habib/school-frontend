...
const UpdatePassword = () => {
    ...
    const [userData,setuserData] = useState({
        ...
        let sumbitData =()=>{
            setErrors([])
            axios.patch(`http://localhost:5000/api/user/newpassword/${params.id}`,userData,{withCredentials:true})
  ...
  return (
    ...
    <div  className={style.container}>
       ...
       <p className={style.title}>Update Password </p>
       {  
       ...
       <label className={style.label} >
           ...
           <span className={style.span}> New password</span>
       </label> 
